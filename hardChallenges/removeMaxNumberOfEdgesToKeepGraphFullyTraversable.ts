// First Approach - Union Find approach iterating first type 3 edges (most valuable), and type 1 and 2 individually after to get the minimum number of edges to iterate all the graph
function maxNumEdgesToRemove(n: number, edges: number[][]): number {
    ...
    let alice: UnionFind = new UnionFind(n);
    let bob: UnionFind = new UnionFind(n);
    let edgesRequired: number = 0;
